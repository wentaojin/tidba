...
func newStepDisplay(prefix string, inner Task, logger *printer.Logger) *StepDisplay {
...
func printDpPlain(logger *printer.Logger, dp *progress.DisplayProps) {
	switch dp.Mode {
